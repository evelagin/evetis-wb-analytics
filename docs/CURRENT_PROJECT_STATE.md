...
Ближайший небольшой этап — **блок «Расчёты с Wildberries»** в Executive:
к перечислению за товар → удержания после реализации → к выплате WB. Формула
доказана Stage 3.1E, требуется только вывод на экран.
