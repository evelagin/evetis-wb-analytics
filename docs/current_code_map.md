...
|---|---|
| Реализован; рабочий статус требует сверки на контрольном периоде |
| Реализован; требует контрольной сверки перед использованием как канонического источника |
| CLEAN-слой (`CLEAN_WB_DAILY`) | Реализован, рабочий |
